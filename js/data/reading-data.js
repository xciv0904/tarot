...
var topicQuestionConfig = {
  love: {
    ...
    focusGroups: [
      ...
      { title: '自我成長', options: ['我在感情中的慣性模式', '我在這段關係中的盲點', '我為什麼總被同類型的人吸引', '我最需要調整的關係課題', '我該怎麼守住自己的底線', '我目前最需要療癒的情緒', '我如何提升自己的關係選擇力'] },
    ],
  ...
  family: {
    ...
    focusGroups: [
      ...
      { title: '內在家庭模式', options: ['原生家庭如何影響我的選擇', '我是否重複了家人的關係模式', '我在家中最容易壓抑什麼', '哪一種家庭信念正在限制我', '和家人之間，我需要重新拿捏哪些分寸', '如何兼顧家人與自己的需求'] },
    ],
