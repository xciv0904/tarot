...
var topicQuestionConfig = {
  love: {
    ...
    focusGroups: [
      { key: 'together', title: '已經在一起（交往中）', options: ['對方目前對我的真實感受', '對方是否有進一步發展的意願', '關係接下來三個月的發展', '這段關係目前最大的阻礙', '我們之間的付出是否平衡', '這段關係是否值得繼續投入', '我們是否適合穩定交往', '這段關係能否走向承諾'] },
      { key: 'single', title: '單身、曖昧中或還沒在一起', options: ['對方只是友善還是有好感', '曖昧關係是否會明朗化', '對方遲遲不表態的原因', '新對象何時較容易出現', '未來可能遇到什麼類型的人', '我目前吸引到的是什麼類型', '是否存在其他競爭者或干擾'] },
      { key: 'breakup', title: '已經分開、想復合', options: ['復合的可能性與條件', '對方是否仍然留戀', '分開後對方的真實想法', '造成分手的核心原因', '復合後是否會重複舊問題', '我是否適合主動聯絡', '這段關係是否已經真正結束'] },
      { key: 'self', title: '自我成長（任何狀態都適用）', options: ['我在感情中的慣性模式', '我在這段關係中的盲點', '我為什麼總被同類型的人吸引', '我最需要調整的關係課題', '我該怎麼守住自己的底線', '我目前最需要療癒的情緒', '我如何提升自己的關係選擇力'] },
    ],
  ...
  career: {
    ...
    focusGroups: [
      { key: 'current', title: '目前工作', options: ['現在的工作是否適合我', '工作中最大的壓力來源', '我目前最容易被忽略的能力', '現職接下來三個月的發展', '工作環境是否值得繼續投入', '我與主管或同事的互動狀況', '目前是否有升遷或加薪機會'] },
      ...
      { key: 'longterm', title: '長期發展', options: ['我的職涯核心優勢', '我容易在哪種工作中發揮', '我真正重視的工作價值', '未來一年的職涯發展重點', '我是否適合創業或接案', '我目前職涯中的盲點', '如何建立更穩定的職涯方向'] },
    ],
  ...
  family: {
    ...
    focusGroups: [
      { key: 'relations', title: '家庭關係', options: ['我和家人的關係目前卡在哪裡', '家人真正擔心的是什麼', '家庭中的溝通是否存在誤解', '我在家庭中承擔了什麼角色', '哪段家庭關係最需要修復', '我是否承擔了過多責任', '如何改善目前的家庭氣氛'] },
      ...
      { key: 'origin', title: '從小到大受到的影響', options: ['原生家庭如何影響我的選擇', '我是否重複了家人的關係模式', '我在家中最容易壓抑什麼', '哪一種家庭信念正在限制我', '和家人之間，我需要重新拿捏哪些分寸', '如何兼顧家人與自己的需求'] },
    ],
  ...
  health: {
    ...
    focusGroups: [
      { key: 'state', title: '身心狀態', options: ['我目前的壓力主要來自哪裡', '哪一種情緒最需要被照顧', '我的身體可能在提醒我什麼', '我目前是否過度消耗自己', '哪一種生活模式正在影響狀態', '我現在最需要休息還是調整節奏'] },
  ...
  wealth: {
    ...
    focusGroups: [
      ...
      { key: 'spending', title: '支出與金錢習慣', options: ['我目前最大的財務漏洞', '哪種消費習慣需要調整', '我對金錢的焦慮來自哪裡', '我是否為了情緒而花錢', '如何建立更穩定的儲蓄習慣', '我目前最應優先處理的財務事項'] },
      { key: 'invest', title: '投資與財務選擇', options: ['我目前的決策是否過度冒險', '我在財務判斷中的盲點', '這項支出是否符合長期目標', '我應該保守觀察還是積極行動', '哪些資訊需要再確認', '我是否受到他人意見過度影響'] },
  ...
  social: {
    ...
    focusGroups: [
      ...
      { key: 'ownpattern', title: '我自己的人際慣性', options: ['我在人際關係中的慣性模式', '我為什麼容易感到被排斥', '我是否過度解讀別人的反應', '我吸引到的是什麼類型的朋友', '我在人際中的優勢與盲點', '我如何建立更自在的人際關係'] },
    ],
  ...
  study: {
    ...
    focusGroups: [
      ...
      { key: 'method', title: '學習方法', options: ['哪一種學習方式最適合我', '我為什麼容易拖延', '我應該先補基礎還是衝進度', '如何提高專注與記憶效率', '我是否安排了過多目標', '哪個學習習慣最需要調整', '如何建立可持續的讀書節奏'] },
  ...
  general: {
    ...
    focusGroups: [
      { key: 'now', title: '近期整體狀態', options: ['我目前正處於什麼人生階段', '接下來三個月的整體趨勢', '我目前最需要關注的領域', '哪一件事正在消耗我最多能量', '現在最值得投入的是什麼', '近期可能出現的重要轉折'] },
      { key: 'choice', title: '選擇與優先順序', options: ['我目前最該優先處理什麼', '兩個選擇之間應如何判斷', '我現在適合前進還是等待', '哪件事可以暫時放下', '我是否忽略了更重要的問題', '我目前的決定受到什麼影響'] },
      { key: 'inner', title: '心情與內在感受', options: ['我真正想要的是什麼', '我目前最大的內在矛盾', '我為什麼一直停在原地', '我最需要放下的是什麼', '哪一種恐懼正在限制我', '我目前最需要相信自己的地方'] },
      { key: 'action', title: '行動方向', options: ['我下一步最適合做什麼', '哪一項改變最能帶來進展', '我需要主動爭取還是先觀察', '如何讓生活重新有方向', '我現在可以從哪個小步驟開始', '哪一種資源可以幫助我'] },
    ],
