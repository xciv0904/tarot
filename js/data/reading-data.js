...
var topicQuestionConfig = {
  love: {
    ...
    focusGroups: [
      { title: '已經在一起（交往中）', options: ['對方目前對我的真實感受', '對方是否有進一步發展的意願', '關係接下來三個月的發展', '這段關係目前最大的阻礙', '我們之間的付出是否平衡', '這段關係是否值得繼續投入', '我們是否適合穩定交往', '這段關係能否走向承諾'] },
      { title: '單身、曖昧中或還沒在一起', options: ['對方只是友善還是有好感', '曖昧關係是否會明朗化', '對方遲遲不表態的原因', '新對象何時較容易出現', '未來可能遇到什麼類型的人', '我目前吸引到的是什麼類型', '是否存在其他競爭者或干擾'] },
      { title: '已經分開、想復合', options: ['復合的可能性與條件', '對方是否仍然留戀', '分開後對方的真實想法', '造成分手的核心原因', '復合後是否會重複舊問題', '我是否適合主動聯絡', '這段關係是否已經真正結束'] },
      { title: '自我成長（任何狀態都適用）', options: ['我在感情中的慣性模式', '我在這段關係中的盲點', '我為什麼總被同類型的人吸引', '我最需要調整的關係課題', '我該怎麼守住自己的底線', '我目前最需要療癒的情緒', '我如何提升自己的關係選擇力'] },
    ],
  ...
  family: {
    ...
    focusGroups: [
      ...
      { title: '父母與長輩', options: ['我和父母之間的核心課題', '長輩對我的真實期待', '我該怎麼把自己的底線說出口', '家人的反對是否有合理之處', '我適合順從、協調還是堅持', '如何減少與長輩的衝突'] },
      { title: '居住與家庭決定', options: ['我現在適合搬家嗎', '和家人同住是否適合目前的我', '居住環境目前帶來什麼影響', '家庭中的重大決定應注意什麼', '是否適合共同購屋或搬遷', '目前最需要優先處理的家庭問題'] },
      { title: '從小到大受到的影響', options: ['原生家庭如何影響我的選擇', '我是否重複了家人的關係模式', '我在家中最容易壓抑什麼', '哪一種家庭信念正在限制我', '和家人之間，我需要重新拿捏哪些分寸', '如何兼顧家人與自己的需求'] },
    ],
  ...
  health: {
    ...
    focusGroups: [
      ...
      { title: '生活習慣', options: ['我最需要改善的生活習慣', '睡眠與作息目前有什麼問題', '我如何建立更穩定的運動習慣', '哪種自我照顧方式更適合我', '我是不是常忽略身體發出的警訊', '如何減少長期累積的疲憊'] },
      { title: '情緒與心理照顧', options: ['我目前最需要處理的情緒', '哪一種擔憂正在反覆消耗我', '我如何恢復內在安全感', '我是否把太多情緒壓在心裡', '哪種支持最適合現在的我', '我應該如何安排休息與求助'] },
      { title: '恢復與調整', options: ['我目前恢復狀態的阻礙', '哪一種調整最值得優先開始', '我需要放慢還是重新建立動力', '如何讓生活回到較穩定的節奏', '哪些責任可以暫時放下', '為了健康，我最需要開始拒絕的是什麼'] },
    ],
  ...
  wealth: {
    ...
    focusGroups: [
      ...
      { title: '合作與共同財務', options: ['合作中的金錢分配是否公平', '我是否適合與對方共同投資', '借貸或共同支出應注意什麼', '這段合作中是否有資訊不透明', '在金錢上，我最需要守住哪一條底線', '金錢問題是否正在影響關係'] },
    ],
  ...
  social: {
    ...
    focusGroups: [
      ...
      { title: '分寸與衝突', options: ['我是否過度迎合他人', '我最需要守住的是哪一種底線', '這場衝突的真正原因', '我適合主動和解嗎', '對方是否願意溝通', '我應該解釋、等待還是離開', '如何避免再次陷入相同問題'] },
      { title: '我自己的人際慣性', options: ['我在人際關係中的慣性模式', '我為什麼容易感到被排斥', '我是否過度解讀別人的反應', '我吸引到的是什麼類型的朋友', '我在人際中的優勢與盲點', '我如何建立更自在的人際關係'] },
    ],
  ...
  general: {
    ...
    focusGroups: [
      ...
      { title: '心情與內在感受', options: ['我真正想要的是什麼', '我目前最大的內在矛盾', '我為什麼一直停在原地', '我最需要放下的是什麼', '哪一種恐懼正在限制我', '我目前最需要相信自己的地方'] },
