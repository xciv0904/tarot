...
var ASTRO_WEALTH_BLINDSPOT_DIMENSIONS = {
  visibility:{ risk:'為了證明能力或維持體面而超出預算', cost:'支出換來短期認可，後續現金壓力卻由自己承擔', action:'購買前先寫下這筆錢解決的實際需要，不把面子算進理由', saving:'收入進帳時先轉出固定比例，再安排形象或享受支出', riskCheck:'先確認最壞情況是否會影響房租、生活費與緊急預備金' },
...
var ASTRO_APPEARANCE_PLAIN_DATASET = {
  火:{ headline:'外型偏鮮明俐落，整體很有存在感', visual:'穿著或姿態較俐落，常用明確線條或醒目重點增加辨識度', vibe:'眼神與談吐偏直接，給人有精神、行動快的第一印象' },
  土:{ headline:'外型偏沉穩耐看，整體給人可靠感', visual:'穿著多半簡潔實用，重視材質、整齊與能長期使用的款式', vibe:'姿態與談吐較穩定，給人不浮誇、做事有分寸的印象' },
  風:{ headline:'外型偏清爽俐落，帶有輕盈知性感', visual:'穿著容易出現簡潔剪裁或靈活變化，整體看起來乾淨不厚重', vibe:'眼神與談吐反應快，給人聰明、好聊且帶點距離感的印象' },
  水:{ headline:'外型偏柔和細膩，整體帶有親近感', visual:'穿著與線條較柔軟，容易用低對比色彩或細節營造溫和感', vibe:'眼神與表情較有情緒流動，給人敏感、安靜或浪漫的印象' },
};
var ASTRO_ATTRACTION_PLAIN_DATASET = {
  火:{ headline:'有主見、敢行動的人最容易讓你心動', trait:'有自信、有主見，喜歡就會明確表達，不讓關係一直停在猜測', interaction:'對方主動提出邀約或清楚表態時，你會更快注意到這份吸引力' },
  土:{ headline:'可靠、有生活秩序的人最容易讓你心動', trait:'做事穩定、說到做到，也願意把時間與責任安排清楚', interaction:'對方持續兌現小承諾，而不是只在一開始表現熱情時，你會更想靠近' },
  風:{ headline:'好聊、有想法的人最容易讓你心動', trait:'反應快、願意交換觀點，也能尊重彼此不同的想法與選擇', interaction:'聊天能接住彼此的話題，又能提出新角度時，你通常會很快產生興趣' },
  水:{ headline:'溫柔、有情緒回應的人最容易讓你心動', trait:'溫柔且能察覺感受，願意陪伴，也不會把你的脆弱當成麻煩', interaction:'對方記得你在意的小事，並在你需要時給出具體回應，最容易打動你' },
};
var ASTRO_RELATIONSHIP_STYLE_PLAIN_DATASET = {
  Sun:{ headline:'適合彼此平等、都能做主的關係', mode:'彼此清楚表達喜歡與立場，重要決定一起討論，但不替對方做主', rhythm:'保持主動聯絡，也保留各自追求目標與被看見的空間' },
  Moon:{ headline:'適合有日常陪伴感的穩定關係', mode:'用固定陪伴、日常照顧與直接說感受建立熟悉感', rhythm:'聯絡與見面需要相對穩定，情緒有變化時能及時回應' },
  Mercury:{ headline:'適合願意持續交流的關係', mode:'遇到問題願意談清楚，也能分享日常資訊與新的想法', rhythm:'適合頻率靈活但不中斷的聯絡，保留交流與各自思考時間' },
  Venus:{ headline:'適合能公平協商的關係', mode:'有分歧時先協調出雙方都接受的做法，不靠忍耐維持和諧', rhythm:'互動重視品質與禮貌，親近之餘仍尊重彼此偏好與界線' },
  Mars:{ headline:'適合能一起行動的關係', mode:'想做什麼直接說，遇到問題共同處理，但不逼對方跟上同一速度', rhythm:'關係需要有行動與共同目標，也要安排降溫和各自休息的時間' },
  Jupiter:{ headline:'適合能一起成長的關係', mode:'一起學習、旅行或拓展生活經驗，同時把承諾範圍說清楚', rhythm:'保留探索新事物的彈性，也固定確認長期方向是否一致' },
  Saturn:{ headline:'適合責任清楚、可以長期累積的關係', mode:'把承諾、責任與未來安排說明白，用持續行動建立信任', rhythm:'步調可以慢，但聯絡、分工與重要決定需要穩定且可預期' },
  Uranus:{ headline:'適合能保有各自生活的關係', mode:'尊重彼此不同的生活方式，不用傳統規則限制關係', rhythm:'各自保有空間與朋友，也約定最低聯絡頻率避免突然斷線' },
  Neptune:{ headline:'適合溫柔但不靠猜測的關係', mode:'保留情感共鳴與浪漫，也把期待、時間與界線說成具體安排', rhythm:'需要溫和而有回應的互動，同時避免只靠默契猜測對方' },
  Pluto:{ headline:'適合能深入坦白的關係', mode:'重要議題願意深入談，彼此坦白真正介意的事，不用試探換安全感', rhythm:'親密可以很深，但仍要允許暫停、消化與逐步建立信任' },
};
var ASTRO_RELATIONSHIP_REPAIR_PLAIN_DATASET = {
  Sun:{ headline:'修復要先讓雙方都有發言權', first:'先停止爭誰比較有道理，讓雙方各自說完真正介意的立場', repair:'確認這次由誰做決定、誰負責哪一步，再用後續行動恢復信任' },
  Moon:{ headline:'先恢復能好好說話的狀態', first:'先讓情緒降到能正常說話，再各自說出受傷與不安的地方', repair:'用一次具體陪伴或回應證明有聽懂，不急著用道理蓋過感受' },
  Mercury:{ headline:'先確認兩人正在談同一件事', first:'先把事件、推測與感受分開，確認雙方爭論的是不是同一件事', repair:'各自重述一次對方的意思，再約定一個可以檢查的下一步' },
  Venus:{ headline:'坦白分歧，是修復的起點', first:'先說出一項真正不同意的地方，不再只維持表面和氣', repair:'找出雙方都能接受的修正方案，並確認這不是由一個人單方面退讓' },
  Mars:{ headline:'先停止攻防，才能回到問題本身', first:'先暫停追問與反擊，等語氣恢復正常後再回到問題', repair:'把衝突縮成一件可處理的事，確認誰要在什麼時間做出改變' },
  Jupiter:{ headline:'別讓一次爭執否定整段關係', first:'先縮小爭議範圍，不把一次衝突延伸成對整段關係的判決', repair:'重新確認共同方向，再把承諾改成目前真正做得到的範圍' },
  Saturn:{ headline:'修復的關鍵是重新建立可信度', first:'先確認哪一項承諾沒有做到，以及它對另一方造成什麼影響', repair:'重新約定責任、期限與完成標準，之後用一致行動累積可信度' },
  Uranus:{ headline:'先保留空間，但不能讓對話斷線', first:'先說明需要多少冷靜空間，也約定何時回來繼續談', repair:'允許彼此提出不同做法，但保留最低聯絡與共同責任' },
  Neptune:{ headline:'先把猜測換成可以回答的問題', first:'先核對實際發生的事，不用猜測替對方補上動機', repair:'把感受與期待說成具體請求，確認彼此是否真的願意做到' },
  Pluto:{ headline:'先停止試探，才有可能重建信任', first:'先停止試探、翻舊帳或要求立刻交代全部，聚焦最核心的一件事', repair:'逐步說清底線與害怕失去的部分，再用可驗證的行動重建信任' },
};
