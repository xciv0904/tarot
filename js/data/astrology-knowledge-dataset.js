...
var ASTRO_PARTNER_PLAIN_DATASET = {
  ...
  Neptune:{ personality:'溫柔敏感、富有想像力，也容易感受他人情緒', interaction:'重視默契與情感共鳴，常以創作或細膩關心建立連結', staying:'有同理心，也能把承諾、界線與現實安排說清楚' },
...
var ASTRO_FAMILY_ORIGIN_PLAIN_DATASET = {
  ...
  Neptune:{ habit:'家庭界線可能較模糊，常靠默契、犧牲或猜測理解彼此', impact:'容易吸收家人的情緒，卻不確定哪些責任真正屬於自己', correction:'用具體事實、時間與責任範圍取代「你應該懂我」' },
...
var ASTRO_INNER_SAFETY_PLAIN_DATASET = {
  ...
  Venus:{ action:'整理出舒服的環境，並與能尊重界線的人保持穩定聯絡', routine:'練習在小事上說出喜歡與不喜歡，不再一律配合' },
