...
var PLANET_BEGINNER = {
  ...
  Mars:{question:'你想要一件事時，會怎麼採取行動？',verb:'爭取想要的事、說出慾望與底線',result:'把想法變成實際行動',strength:'能在需要時拿出勇氣與推進力',watch:'留意衝動、壓抑怒氣，或把所有事情都當成競爭',
    coreNeed:['把想要的東西真的爭取到手','把心裡的衝勁化為實際行動'],function:'把慾望變成具體行動，守住自己的底線',matureAim:'拿捏力道、果斷推進',imbalance:'衝動行事後又後悔，或悶著怒氣不說'},
  ...
  Saturn:{question:'你在哪裡需要練習耐心、責任，以及對別人說不？',verb:'面對責任、建立規則並累積實力',result:'得到真正可靠的安全感與能力',strength:'願意長期投入，最後形成別人取代不了的專業',watch:'不要因為怕犯錯而過度嚴格、拖延或否定自己',
    coreNeed:['換來真正可靠、拿得出來的實力','打下經得起考驗的基礎'],function:'建立紀律、承擔責任，並劃出清楚的底線',matureAim:'扛得住壓力、值得信任',imbalance:'害怕犯錯而不斷拖延、自我否定'},
...
var SIGN_BEGINNER = [
  ...
  {mode:'跟著直覺、感受與想像慢慢靠近答案',behavior:'先感受整體氛圍，再用同理或創意回應',strength:'能用細膩的想像力，理解難以言說的感受',watch:'分不清你我時容易受影響、逃避，或把人理想化',
    motivation:'想貼近說不清楚、但確實存在的感受與理想',method:'靠直覺和同理去感受',matureExpression:'能用細膩的想像力理解別人，也守得住自己的底線',shadow:'你我不分到被別人的情緒淹沒，或用逃避代替面對'}
];
var HOUSE_BEGINNER = [
  ...
  {area:'親密、信任、共同金錢、失去與人生重大轉折',example:'需要談清楚金錢、底線、秘密，或陪自己／別人走過低潮',
...
var ASPECT_DEFS = {
  conjunction: { zh: '合相', tpl: '緊密融合，{A}的{ak}與{B}的{bk}疊加在一起，力量集中但也可能難以分辨哪些是你的、哪些是對方的' },
