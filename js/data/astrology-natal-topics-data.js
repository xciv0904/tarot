...
var NATAL_TOPIC_QUESTIONS = {
  love: [
    { id: 'love-partner-type', title: '我常遇到什麼類型的對象？', intent: 'partner_profile', questionFocus: 'likely_partner_traits',
    ...
    { id: 'love-attract-type', title: '什麼特質最容易讓我心動？', intent: 'attraction_pattern', questionFocus: 'emotional_attraction',
    ...
    { id: 'love-relationship-style', title: '什麼樣的相處方式最適合我？', intent: 'style', questionFocus: 'preferred_relationship_style',
    ...
    { id: 'love-conflict-repair', title: '關係發生衝突後，我適合怎麼修復？', intent: 'direction', questionFocus: 'relationship_repair',
      answerTargets: ['衝突後適合先做的事', '重新建立溝通與信任的方式'],
      excludedTargets: ['一般感情盲點', '平時的相處模式'],
      detailLabels: ['衝突後的第一步', '修復關係的方式'],
      cautionFocus: 'relational',
      evidenceBias: { preferPlanets: ['Moon', 'Mercury', 'Venus', 'Mars'], preferTypes: ['houseRuler', 'aspectsInvolving'] },
      indicators: [
      { type: 'planet', key: 'Moon' }, { type: 'planet', key: 'Mercury' }, { type: 'planet', key: 'Venus' },
      { type: 'planet', key: 'Mars' }, { type: 'houseRuler', house: 7 },
      { type: 'aspectsInvolving', keys: ['Moon', 'Mercury', 'Venus', 'Mars'] },
    ] },
  ],
  career: [
    { id: 'career-work-type', title: '我適合負責哪些工作內容？', intent: 'career_direction', questionFocus: 'suitable_roles',
    ...
    { id: 'career-core-skill', title: '我在職場最拿手的是什麼？', intent: 'career_strength', questionFocus: 'workplace_advantages',
  ...
  family: [
    ...
    { id: 'family-boundary', title: '和家人之間，我需要守住哪些底線', intent: 'challenge', questionFocus: 'family_boundary_setting',
  ...
  health: [
    { id: 'health-stress-pattern', title: '壓力大時，我通常會出現哪些反應？', intent: 'pattern', questionFocus: 'stress_reaction_pattern',
    ...
    { id: 'health-body-boundary', title: '我容易忽略身體的哪些警訊', intent: 'challenge', questionFocus: 'body_boundary_blindspot',
    ...
    { id: 'health-self-care', title: '什麼方式最能幫我恢復精力？', intent: 'safety', questionFocus: 'recovery_method',
      answerTargets: ['真正有恢復效果的活動', '適合安排的休息節奏'],
      excludedTargets: ['壓力發生後的反應', '醫療診斷'],
    ...
    { id: 'health-energy-drain', title: '哪些日常情境最容易消耗我的能量？', intent: 'challenge', questionFocus: 'energy_drain_contexts',
      answerTargets: ['容易消耗能量的日常情境', '需要降低負荷的環境條件'],
      excludedTargets: ['壓力發生後的反應', '醫療診斷'],
      detailLabels: ['容易消耗你的情境', '需要降低的負荷'],
      cautionFocus: 'overextension',
      evidenceBias: { preferPlanets: ['Saturn', 'Mars', 'Neptune'], preferTypes: ['housePlanets', 'houseRuler'] },
      indicators: [
      { type: 'planet', key: 'Saturn' }, { type: 'planet', key: 'Mars' }, { type: 'planet', key: 'Neptune' },
      { type: 'housePlanets', house: 6 }, { type: 'housePlanets', house: 12 }, { type: 'houseRuler', house: 6 },
    ] },
  ],
  wealth: [
    { id: 'wealth-earning-style', title: '我適合靠哪種收入模式賺錢？', intent: 'pattern', questionFocus: 'earning_style',
    ...
    { id: 'wealth-monetizable', title: '哪些能力最容易替我帶來收入？', intent: 'capability', questionFocus: 'wealth_monetizable_skills',
  ...
  social: [
    ...
    { id: 'social-boundary-conflict', title: '我的底線與面對衝突的方式', intent: 'tension', questionFocus: 'boundary_conflict_pattern',
    ...
    { id: 'social-circle-fit', title: '什麼樣的朋友圈最適合我？', intent: 'fit', questionFocus: 'social_circle_fit',
  ...
  study: [
    { id: 'study-learning-style', title: '我用什麼方法最容易學會？', intent: 'style', questionFocus: 'learning_style',
    ...
    { id: 'study-mode-fit', title: '我比較適合學習哪一類內容？', intent: 'fit', questionFocus: 'study_mode_fit',
    ...
    { id: 'study-rhythm', title: '我如何安排讀書時間比較有效？', intent: 'safety', questionFocus: 'study_rhythm',
    ...
    { id: 'study-mastery-evidence', title: '我適合用什麼成果證明自己學會了？', intent: 'capability', questionFocus: 'mastery_evidence',
      answerTargets: ['適合展現學習成果的形式', '判斷自己真正學會的標準'],
      excludedTargets: ['一般學習方法', '適合的知識類型'],
      detailLabels: ['適合的成果形式', '真正學會的判斷標準'],
      cautionFocus: 'vigilance',
      evidenceBias: { preferPlanets: ['Mercury', 'Sun', 'Saturn', 'Jupiter'], preferTypes: ['houseRuler'] },
      indicators: [
      { type: 'planet', key: 'Mercury' }, { type: 'planet', key: 'Sun' }, { type: 'planet', key: 'Saturn' },
      { type: 'planet', key: 'Jupiter' }, { type: 'houseRuler', house: 3 }, { type: 'houseRuler', house: 9 },
    ] },
    { id: 'study-knowledge-application', title: '如何把學到的知識真正用出來？', intent: 'direction', questionFocus: 'knowledge_application',
      answerTargets: ['把知識轉成行動或作品的方式', '適合的輸出與練習形式'],
      excludedTargets: ['記憶資訊的方式', '讀書節奏'],
      detailLabels: ['把知識用出來的方式', '適合的輸出形式'],
      cautionFocus: 'growth',
      evidenceBias: { preferPlanets: ['Mercury', 'Mars', 'Jupiter'], preferTypes: ['houseRuler'] },
      indicators: [
      { type: 'planet', key: 'Mercury' }, { type: 'planet', key: 'Mars' }, { type: 'planet', key: 'Jupiter' },
      { type: 'houseRuler', house: 3 }, { type: 'houseRuler', house: 6 }, { type: 'houseRuler', house: 9 },
    ] },
  ],
  general: [
    { id: 'general-top-themes', title: '命盤中最重要的三個人生課題是什麼？', intent: 'overview', questionFocus: 'top_life_themes',
    ...
    { id: 'general-decision-basis', title: '面對重大選擇時，我最可靠的判斷依據是什麼？', intent: 'direction', questionFocus: 'major_decision_basis',
      ...
      indicators: [
      { type: 'planet', key: 'Sun' }, { type: 'planet', key: 'Moon' }, { type: 'planet', key: 'Saturn' },
      { type: 'planet', key: 'Jupiter' }, { type: 'chartRuler' }, { type: 'nodeAxis' },
    ] },
  ],
};
...
/* ================= V2：Question Definition 支援欄位 =================
   ...
   INTENT_DEFAULT_META 依 intent 自動補上預設值（目前所有題目已全部手動指定，
...
var QUESTIONFOCUS_HOUSE_CATEGORY = {
  ...
  workplace_advantages: 'career_strength',
  ...
  family_origin_impact: 'family_origin',
  family_boundary_setting: 'family_boundary',
  living_environment: 'family_living',
  inner_safety_practice: 'family_safety',
  family_career_balance: 'family_balance',
  stress_reaction_pattern: 'health_stress',
  lifestyle_fit: 'health_lifestyle',
  body_boundary_blindspot: 'health_boundary',
  recovery_method: 'health_recovery',
  energy_drain_contexts: 'health_energy_drain',
  ...
  mastery_evidence: 'study_mastery',
  knowledge_application: 'study_application',
  ...
  major_decision_basis: 'general_decision',
};
