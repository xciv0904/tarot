...
const CACHE = 'mystic-v7';
const CORE = ['./', './index.html', './js/data/reading-data.js', './js/data/astrology-core-data.js', './js/app.js', './manifest.json', './assets/favicon.png', './assets/icon-192.png', './assets/icon-512.png'];
